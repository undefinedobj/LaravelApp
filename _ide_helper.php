 ...
 * Generated for Laravel 5.8.14 on 2019-05-23 14:02:51.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class DB {
        ...
        /**
         * Get the current PDO connection used for view_count.
         *
         * @return \PDO
         * @static
         */
        ...
        /**
         * Set the PDO connection used for view_count.
         *
         * @param \PDO|\Closure|null $pdo
         * @return \Illuminate\Database\MySqlConnection
         * @static
    ...
    class Session {
        ...
        /**
         * Start the session, view_count the data from a handler.
         *
         * @return bool
         * @static
         */
